            ...
            <div class="row no-gutters row-bordered row-border-light">
                <div class="col-md-3 pt-0">
                    <div class="list-group list-group-flush account-settings-links">
                        ...
                        <a class="list-group-item list-group-item-action" data-toggle="list"
                           href="#account-avatar">Загрузка аватара</a>
                    </div>
                </div>
                            ...
                            <div class="card-body" style="padding: 16px">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="userVk" name="userVk"
                                           value="${buyer.userVk}"
                                           placeholder="<c:if test="${buyer.userVk eq null}">Не указано</c:if>">
                                </div>
                                <div class="form-group mb-3">
                                    <label class="form-label">Telegram</label>
                                    <input type="text" class="form-control" id="userTelegram" name="userTelegram"
                                           value="${buyer.userTelegram}"
                                           placeholder="<c:if test="${buyer.userTelegram eq null}">Не указано</c:if>">
                                </div>
                            </div>
                        </div>
